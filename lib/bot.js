...
bot.onText(/^\/start/, function (msg, match) {
  bot.sendMessage(msg.chat.id, 'سلام :-)\nخیلی خوش اومدی. من ربات یابنده‌ي پسورد هستم. تخصصم فعلا پیدا کردن پسورد سرویس مجانی vpnbook هست که هر هفته یکبار ریست میشه.\nمن اینجا آماده باش هستم تا هر وقتی شما دستور «/pass» اینجا وارد کردید برم و براتون پسورد جدید بیارم. برای شروع می‌تونیند همین الان این دستور وارد کنید :-)');
});

// Matches /help
bot.onText(/^\/help/, function (msg, match) {
  bot.sendMessage(msg.chat.id, 'برای دریافت پسورد جدید تنها کافیه که دستور «/pass» به ربات بدید.\nخوش باشید :-)');
});
